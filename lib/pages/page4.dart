...
import 'package:jeu_sanoussi/pages/page5.dart';
...
class _Page4State extends State<Page4> {
  ...
  String title = 'Mon niveau 4';
  String image = 'assets/images/not.png';
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary: (button2Value == 1) 
                      ? Color.fromARGB(255, 3, 107, 105) 
                      : null,
                    ),
          ...
          Positioned(
            ...
            child: Visibility(
              ...
              child: Container(
                ...
                color: estGagnant 
                ? const Color.fromARGB(255, 3, 194, 10) 
                : const Color.fromARGB(255, 155, 12, 2),
                

                child: Text(
                  estGagnant ? 'Vous avez gagné !!!' 
                  : 'Perdu...!!!',
                  style: const TextStyle(fontSize: 20, color: Color.fromARGB(255, 200, 199, 199), fontWeight: FontWeight.bold),
                ),
              ),
            ),
          ),
